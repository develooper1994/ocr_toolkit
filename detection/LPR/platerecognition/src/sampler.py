...
try:
    import Label
    import perspective_transform, find_T_matrix, getRectPts
    import im2single, getWH, hsv_transform, IOU_centre_and_dims
except:
    try:
        from platerecognition.src.label import Label
        from platerecognition.src.projection_utils import perspective_transform, find_T_matrix, getRectPts
        from platerecognition.src.utils import im2single, getWH, hsv_transform, IOU_centre_and_dims
    except:
        try:
            from LPR.platerecognition.src.label import Label
            from LPR.platerecognition.src.projection_utils import perspective_transform, find_T_matrix, getRectPts
            from LPR.platerecognition.src.utils import im2single, getWH, hsv_transform, IOU_centre_and_dims
        except:
            from detection.LPR.platerecognition.src.label import Label
            from detection.LPR.platerecognition.src.projection_utils import perspective_transform, find_T_matrix, \
                getRectPts
            from detection.LPR.platerecognition.src.utils import im2single, getWH, hsv_transform, IOU_centre_and_dims
